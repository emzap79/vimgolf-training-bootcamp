...
set path=~/Dokumente/Linux/Vim/vimgolf/**,~/Unimaterialien
set ruler
...
silent only
cd ~/Dokumente/Linux/Vim/vimgolf
...
setlocal tabstop=4
setlocal tags=~/Dokumente/Linux/Vim/vimgolf/.git/sh.tags,~/Dokumente/Linux/Vim/vimgolf/.git/tags,./tags,./TAGS,tags,TAGS
...
let s:l = 24 - ((14 * winheight(0) + 15) / 30)
